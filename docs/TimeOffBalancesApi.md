...
# **timeOffBalancesList**
> PaginatedTimeOffBalanceList timeOffBalancesList(xAccountToken, createdAfter, createdBefore, cursor, employeeId, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, policyType, remoteId)
...
import merge_hris_client.api.TimeOffBalancesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TimeOffBalancesApi apiInstance = new TimeOffBalancesApi(defaultClient);
    ...
    try {
      ...
      System.err.println("Exception when calling TimeOffBalancesApi#timeOffBalancesList");
...
> TimeOffBalance timeOffBalancesRetrieve(xAccountToken, id, includeRemoteData)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling TimeOffBalancesApi#timeOffBalancesRetrieve");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
