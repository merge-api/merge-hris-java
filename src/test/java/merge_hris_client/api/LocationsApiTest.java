...
public class LocationsApiTest {
    ...
    public void locationsListTest() throws ApiException {
        ...
        PaginatedLocationList response = api.locationsList(xAccountToken, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId);
