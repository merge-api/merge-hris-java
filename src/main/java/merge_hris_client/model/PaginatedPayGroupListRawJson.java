...
public class PaginatedPayGroupListRawJson {
  ...
  public PaginatedPayGroupListRawJson(JSON srlzer) { 
    
    this.serializer = srlzer;
  }

  public PaginatedPayGroupListRawJson next(String next) {
  ...
  **/
  ...
  public PaginatedPayGroupListRawJson previous(String previous) {
  ...
  **/
  ...
  public PaginatedPayGroupListRawJson results(List<PayGroup> results) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PaginatedPayGroupListRawJson paginatedPayGroupList = (PaginatedPayGroupListRawJson) o;
    return Objects.equals(this.next.getAsString(), paginatedPayGroupList.next.getAsString()) &&
        Objects.equals(this.previous.getAsString(), paginatedPayGroupList.previous.getAsString()) &&
        Objects.equals(this.results.getAsString(), paginatedPayGroupList.results.getAsString());
  }
  @Override
  public int hashCode() {
  ...
  public String toString() {
    ...
    sb.append("class PaginatedPayGroupListRawJson {\n");
