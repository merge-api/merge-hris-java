...
/**
 * PaginatedEmployeePayrollRunListRawJson
 */
...
public class PaginatedEmployeePayrollRunListRawJson {
  ...
  public PaginatedEmployeePayrollRunListRawJson(JSON srlzer) { 
    
    this.serializer = srlzer;
  }

  public PaginatedEmployeePayrollRunListRawJson next(String next) {
  ...
  **/
  ...
  public PaginatedEmployeePayrollRunListRawJson previous(String previous) {
  ...
  **/
  ...
  public PaginatedEmployeePayrollRunListRawJson results(List<EmployeePayrollRun> results) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PaginatedEmployeePayrollRunListRawJson paginatedEmployeePayrollRunList = (PaginatedEmployeePayrollRunListRawJson) o;
    return Objects.equals(this.next.getAsString(), paginatedEmployeePayrollRunList.next.getAsString()) &&
        Objects.equals(this.previous.getAsString(), paginatedEmployeePayrollRunList.previous.getAsString()) &&
        Objects.equals(this.results.getAsString(), paginatedEmployeePayrollRunList.results.getAsString());
  }
  @Override
  public int hashCode() {
  ...
  public String toString() {
    ...
    sb.append("class PaginatedEmployeePayrollRunListRawJson {\n");
