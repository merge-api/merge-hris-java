...
/**
 * PaginatedAccountDetailsAndActionsListRawJson
 */
...
public class PaginatedAccountDetailsAndActionsListRawJson {
  ...
  public PaginatedAccountDetailsAndActionsListRawJson(JSON srlzer) { 
    
    this.serializer = srlzer;
  }

  public PaginatedAccountDetailsAndActionsListRawJson next(String next) {
  ...
  **/
  ...
  public PaginatedAccountDetailsAndActionsListRawJson previous(String previous) {
  ...
  **/
  ...
  public PaginatedAccountDetailsAndActionsListRawJson results(List<AccountDetailsAndActions> results) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PaginatedAccountDetailsAndActionsListRawJson paginatedAccountDetailsAndActionsList = (PaginatedAccountDetailsAndActionsListRawJson) o;
    return Objects.equals(this.next.getAsString(), paginatedAccountDetailsAndActionsList.next.getAsString()) &&
        Objects.equals(this.previous.getAsString(), paginatedAccountDetailsAndActionsList.previous.getAsString()) &&
        Objects.equals(this.results.getAsString(), paginatedAccountDetailsAndActionsList.results.getAsString());
  }
  @Override
  public int hashCode() {
  ...
  public String toString() {
    ...
    sb.append("class PaginatedAccountDetailsAndActionsListRawJson {\n");
