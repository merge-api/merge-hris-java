...
public class PaginatedCompanyListRawJson {
  ...
  public PaginatedCompanyListRawJson(JSON srlzer) { 
    
    this.serializer = srlzer;
  }

  public PaginatedCompanyListRawJson next(String next) {
  ...
  **/
  ...
  public PaginatedCompanyListRawJson previous(String previous) {
  ...
  **/
  ...
  public PaginatedCompanyListRawJson results(List<Company> results) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PaginatedCompanyListRawJson paginatedCompanyList = (PaginatedCompanyListRawJson) o;
    return Objects.equals(this.next.getAsString(), paginatedCompanyList.next.getAsString()) &&
        Objects.equals(this.previous.getAsString(), paginatedCompanyList.previous.getAsString()) &&
        Objects.equals(this.results.getAsString(), paginatedCompanyList.results.getAsString());
  }
  @Override
  public int hashCode() {
  ...
  public String toString() {
    ...
    sb.append("class PaginatedCompanyListRawJson {\n");
