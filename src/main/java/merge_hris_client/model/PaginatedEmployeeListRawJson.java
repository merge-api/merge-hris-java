...
public class PaginatedEmployeeListRawJson {
  ...
  public PaginatedEmployeeListRawJson(JSON srlzer) { 
    
    this.serializer = srlzer;
  }

  public PaginatedEmployeeListRawJson next(String next) {
  ...
  **/
  ...
  public PaginatedEmployeeListRawJson previous(String previous) {
  ...
  **/
  ...
  public PaginatedEmployeeListRawJson results(List<Employee> results) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PaginatedEmployeeListRawJson paginatedEmployeeList = (PaginatedEmployeeListRawJson) o;
    return Objects.equals(this.next.getAsString(), paginatedEmployeeList.next.getAsString()) &&
        Objects.equals(this.previous.getAsString(), paginatedEmployeeList.previous.getAsString()) &&
        Objects.equals(this.results.getAsString(), paginatedEmployeeList.results.getAsString());
  }
  @Override
  public int hashCode() {
  ...
  public String toString() {
    ...
    sb.append("class PaginatedEmployeeListRawJson {\n");
