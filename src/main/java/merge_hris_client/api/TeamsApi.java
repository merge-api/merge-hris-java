...
public class TeamsApi {
     ...
     * @param parentTeamId If provided, will only return teams with this parent team. (optional)
    ...
    public okhttp3.Call teamsListCall(String xAccountToken, OffsetDateTime createdAfter, OffsetDateTime createdBefore, String cursor, Boolean includeDeletedData, Boolean includeRemoteData, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, Integer pageSize, String parentTeamId, String remoteId, final ApiCallback _callback) throws ApiException {
        ...
        if (parentTeamId != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("parent_team_id", parentTeamId));
        }
    ...
    private okhttp3.Call teamsListValidateBeforeCall(String xAccountToken, OffsetDateTime createdAfter, OffsetDateTime createdBefore, String cursor, Boolean includeDeletedData, Boolean includeRemoteData, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, Integer pageSize, String parentTeamId, String remoteId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = teamsListCall(xAccountToken, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, parentTeamId, remoteId, _callback);
        return localVarCall;
     ...
     */
    public PaginatedTeamList teamsList(String xAccountToken, OffsetDateTime createdAfter, OffsetDateTime createdBefore, String cursor, Boolean includeDeletedData, Boolean includeRemoteData, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, Integer pageSize, String parentTeamId, String remoteId) throws ApiException {
        ApiResponse<PaginatedTeamList> localVarResp = teamsListWithHttpInfo(xAccountToken, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, parentTeamId, remoteId);
    ...
    public ApiResponse<PaginatedTeamList> teamsListWithHttpInfo(String xAccountToken, OffsetDateTime createdAfter, OffsetDateTime createdBefore, String cursor, Boolean includeDeletedData, Boolean includeRemoteData, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, Integer pageSize, String parentTeamId, String remoteId) throws ApiException {
        okhttp3.Call localVarCall = teamsListValidateBeforeCall(xAccountToken, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, parentTeamId, remoteId, null);
    ...
    public okhttp3.Call teamsListAsync(String xAccountToken, OffsetDateTime createdAfter, OffsetDateTime createdBefore, String cursor, Boolean includeDeletedData, Boolean includeRemoteData, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, Integer pageSize, String parentTeamId, String remoteId, final ApiCallback<PaginatedTeamList> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = teamsListValidateBeforeCall(xAccountToken, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, parentTeamId, remoteId, _callback);
        Type localVarReturnType = new TypeToken<PaginatedTeamList>(){}.getType();
