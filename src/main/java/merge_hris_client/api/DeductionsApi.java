...
public class DeductionsApi {
    ...
    private okhttp3.Call deductionsListValidateBeforeCall(String xAccountToken, OffsetDateTime createdAfter, OffsetDateTime createdBefore, String cursor, String employeePayrollRunId, Boolean includeDeletedData, Boolean includeRemoteData, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, Integer pageSize, String remoteId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deductionsListCall(xAccountToken, createdAfter, createdBefore, cursor, employeePayrollRunId, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, _callback);
        return localVarCall;
    ...
    public PaginatedDeductionList deductionsList(String xAccountToken, OffsetDateTime createdAfter, OffsetDateTime createdBefore, String cursor, String employeePayrollRunId, Boolean includeDeletedData, Boolean includeRemoteData, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, Integer pageSize, String remoteId) throws ApiException {
        ApiResponse<PaginatedDeductionList> localVarResp = deductionsListWithHttpInfo(xAccountToken, createdAfter, createdBefore, cursor, employeePayrollRunId, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId);
    ...
    public ApiResponse<PaginatedDeductionList> deductionsListWithHttpInfo(String xAccountToken, OffsetDateTime createdAfter, OffsetDateTime createdBefore, String cursor, String employeePayrollRunId, Boolean includeDeletedData, Boolean includeRemoteData, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, Integer pageSize, String remoteId) throws ApiException {
        okhttp3.Call localVarCall = deductionsListValidateBeforeCall(xAccountToken, createdAfter, createdBefore, cursor, employeePayrollRunId, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, null);
    ...
    public okhttp3.Call deductionsListAsync(String xAccountToken, OffsetDateTime createdAfter, OffsetDateTime createdBefore, String cursor, String employeePayrollRunId, Boolean includeDeletedData, Boolean includeRemoteData, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, Integer pageSize, String remoteId, final ApiCallback<PaginatedDeductionList> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deductionsListValidateBeforeCall(xAccountToken, createdAfter, createdBefore, cursor, employeePayrollRunId, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, _callback);
        Type localVarReturnType = new TypeToken<PaginatedDeductionList>(){}.getType();
