...
public class TimeOffApi {
     ...
     */
    public okhttp3.Call timeOffCreateCall(String xAccountToken, TimeOffEndpointRequest timeOffEndpointRequest, Boolean isDebugMode, Boolean runAsync, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call timeOffCreateValidateBeforeCall(String xAccountToken, TimeOffEndpointRequest timeOffEndpointRequest, Boolean isDebugMode, Boolean runAsync, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = timeOffCreateCall(xAccountToken, timeOffEndpointRequest, isDebugMode, runAsync, _callback);
        return localVarCall;
     ...
     */
    public TimeOffResponse timeOffCreate(String xAccountToken, TimeOffEndpointRequest timeOffEndpointRequest, Boolean isDebugMode, Boolean runAsync) throws ApiException {
        ApiResponse<TimeOffResponse> localVarResp = timeOffCreateWithHttpInfo(xAccountToken, timeOffEndpointRequest, isDebugMode, runAsync);
     ...
     */
    public ApiResponse<TimeOffResponse> timeOffCreateWithHttpInfo(String xAccountToken, TimeOffEndpointRequest timeOffEndpointRequest, Boolean isDebugMode, Boolean runAsync) throws ApiException {
        okhttp3.Call localVarCall = timeOffCreateValidateBeforeCall(xAccountToken, timeOffEndpointRequest, isDebugMode, runAsync, null);
     ...
     */
    public okhttp3.Call timeOffCreateAsync(String xAccountToken, TimeOffEndpointRequest timeOffEndpointRequest, Boolean isDebugMode, Boolean runAsync, final ApiCallback<TimeOffResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = timeOffCreateValidateBeforeCall(xAccountToken, timeOffEndpointRequest, isDebugMode, runAsync, _callback);
        Type localVarReturnType = new TypeToken<TimeOffResponse>(){}.getType();
    ...
    private okhttp3.Call timeOffListValidateBeforeCall(String xAccountToken, String approverId, OffsetDateTime createdAfter, OffsetDateTime createdBefore, String cursor, String employeeId, Boolean includeDeletedData, Boolean includeRemoteData, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, Integer pageSize, String remoteId, String requestType, String status, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = timeOffListCall(xAccountToken, approverId, createdAfter, createdBefore, cursor, employeeId, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, requestType, status, _callback);
        return localVarCall;
    ...
    public PaginatedTimeOffList timeOffList(String xAccountToken, String approverId, OffsetDateTime createdAfter, OffsetDateTime createdBefore, String cursor, String employeeId, Boolean includeDeletedData, Boolean includeRemoteData, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, Integer pageSize, String remoteId, String requestType, String status) throws ApiException {
        ApiResponse<PaginatedTimeOffList> localVarResp = timeOffListWithHttpInfo(xAccountToken, approverId, createdAfter, createdBefore, cursor, employeeId, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, requestType, status);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<PaginatedTimeOffList> timeOffListWithHttpInfo(String xAccountToken, String approverId, OffsetDateTime createdAfter, OffsetDateTime createdBefore, String cursor, String employeeId, Boolean includeDeletedData, Boolean includeRemoteData, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, Integer pageSize, String remoteId, String requestType, String status) throws ApiException {
        okhttp3.Call localVarCall = timeOffListValidateBeforeCall(xAccountToken, approverId, createdAfter, createdBefore, cursor, employeeId, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, requestType, status, null);
    ...
    public okhttp3.Call timeOffListAsync(String xAccountToken, String approverId, OffsetDateTime createdAfter, OffsetDateTime createdBefore, String cursor, String employeeId, Boolean includeDeletedData, Boolean includeRemoteData, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, Integer pageSize, String remoteId, String requestType, String status, final ApiCallback<PaginatedTimeOffList> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = timeOffListValidateBeforeCall(xAccountToken, approverId, createdAfter, createdBefore, cursor, employeeId, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, requestType, status, _callback);
        Type localVarReturnType = new TypeToken<PaginatedTimeOffList>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for timeOffMetaPostRetrieve
     * @param xAccountToken Token identifying the end user. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call timeOffMetaPostRetrieveCall(String xAccountToken, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/time-off/meta/post";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call timeOffMetaPostRetrieveValidateBeforeCall(String xAccountToken, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'xAccountToken' is set
        if (xAccountToken == null) {
            throw new ApiException("Missing the required parameter 'xAccountToken' when calling timeOffMetaPostRetrieve(Async)");
        }
        

        okhttp3.Call localVarCall = timeOffMetaPostRetrieveCall(xAccountToken, _callback);
        return localVarCall;
     ...
     */
    public MetaResponse timeOffMetaPostRetrieve(String xAccountToken) throws ApiException {
        ApiResponse<MetaResponse> localVarResp = timeOffMetaPostRetrieveWithHttpInfo(xAccountToken);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<MetaResponse> timeOffMetaPostRetrieveWithHttpInfo(String xAccountToken) throws ApiException {
        okhttp3.Call localVarCall = timeOffMetaPostRetrieveValidateBeforeCall(xAccountToken, null);
     ...
     */
    public okhttp3.Call timeOffMetaPostRetrieveAsync(String xAccountToken, final ApiCallback<MetaResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = timeOffMetaPostRetrieveValidateBeforeCall(xAccountToken, _callback);
        Type localVarReturnType = new TypeToken<MetaResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
